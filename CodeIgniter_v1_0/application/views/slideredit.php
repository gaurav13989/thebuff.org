...
<script type="text/javascript">
	$(function(){
		$('.edit').live('click',function(){
	        ...
	        p['imageUrl'] = $(this).parent().parent().find('.imageUrl').val();
	        ...
	        $(this).parent().load('/v1_0/update/slider/'+p['id'],p,function(html){
	        	if(html == "y")
		        {
		...
		$('.delete').live("click",function(){
			...
			if(temp)
			{
		        ...
		        $(this).parent().parent().find(".loading").html('<img src="<?=base_url();?>images/loading.gif" />');
		        $(this).parent().load('/v1_0/delete/slider/'+p['id'],p,function(html){
		        	if(html == "y")
		        	{
		        		$(this).parent().find(".loading").html('<img src="<?=base_url();?>images/tick.jpg" />');
	...
	<div style="max-height: 200px; overflow: auto;">
		<table style="overflow-y: scroll; text-align: center;">
			...
			<tr>
				...
				<td width="100px"><input type="text" class="imageUrl" value="<?=$row->imageUrl;?>"/></td>
...
<div>
	<br/>
	Insert new row here
	<form name="form1" method="POST" action="<?php echo base_url();?>v1_0/insert/slider">
		<table>
			<tr>
				<td>IMAGE URL</td>
