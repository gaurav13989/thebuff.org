...
$(function(){
	...
	$('.LCStitle').click(function(){
		...
		$(this).parent().next().animate({
			...
			if(ht != "5px")
			{
				$('html, body').animate({scrollTop: $(this).offset().top-140}, 1500);		
			}
		});
	});
	...
	$("#leftColBody").find(">:first-child").find(".LCStitle").trigger('click');
			...
			<div id="leftCol">
				<div id="leftColBody" style="min-height: 450px;">
					...
					<div class="leftColStory">
						<div>
							<div class="leftVertical LCStitleHt" style='font-family: Cambria'></div>
							<a href="note/<?=$row->noteShortName;?>" target="_blank" title="Open in a new tab"><div class="openNewWinIcon">&nbsp;</div></a>
							<div class="LCStitle" style='font-family: Cambria; font-weight: bold;'><?=$row->noteTitle;?></div>
							<div class="clear"></div>
						</div>
						<div class="LCSbody" style="text-align: justify; font-size: 14px; line-height: 150%;">
							<div class="space"></div>
							<?=$row->note;?>
							<div class="space"></div>
